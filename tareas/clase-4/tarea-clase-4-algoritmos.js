...
/*
function imprimirTablas(numeroDeTabla){
  for(let i = 0; i <= 10; i++){
...
//Desafío de programación #5: Calcula el resultado de la suma 
//de los numeros del 1 al 10 en un array.
...
for(let i = 0; i < array.length; i+=2){
  calculoFactorial = array[i] * array[i+1];
...
/*
let gradosCelsius = Number(prompt('Ingrese los grados Celsius '));

function transformarGradosCelsius(){
  return (gradosCelsius * 9/5) + 32;
}
let gradosFahrenheit = transformarGradosCelsius();

console.log(`Los ${gradosCelsius} grados Celsius son ${gradosFahrenheit} grados Fahrenheit`);
*/

//Desafío de programación #9: Crea una función que convierta de Fahrenheit a Celsius
/*
let gradosFahrenheit = Number(prompt('Ingrese los grados Fahrenheit '));

function convertirFahrenheit_a_Celsius(){
  return (gradosFahrenheit - 32) * 5/9;
}
let gradosCelsius = convertirFahrenheit_a_Celsius();

console.log(`Los ${gradosFahrenheit} grados Fahrenheit son ${gradosCelsius} grados Celsius`);
*/
