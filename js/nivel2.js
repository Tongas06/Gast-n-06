...
const comidasFavoritas = ['hamburguesa', 'pizza', 'canelones', 'empanadas'];
...
// TAREA: Obtené el tercer elemento de tu array comidasFavoritas e imprimilo utilizando 
//console.log.
...
    array todavía se pueden cambiar; el array en sí no se puede sobrescribir.
    ...
    // Esto es ilegal y devolverá un error igual al que se genera al cambiar 
       cualquier constante:
...
console.log(totalNotas / notaParciales.length);
...
const notaParciales = [10, 9, 7, 5];
let totalNotas = calcularPromedio(notaParciales);
...
let comidasFavoritas1 = ['pescado', 'albondigas','asado','empanadas'];

for(let i = 0; i < comidasFavoritas1.length; i++){
    console.log('Me gustan las comidas como ' + comidasFavoritas1[i]);
}
