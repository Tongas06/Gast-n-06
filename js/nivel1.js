...
/*
    ...
    Una variable es un lugar para guardar información. 
    Para crear (o mejor dicho DECLARAR) una variable usamos 'let',
    así:
...
/*
    ...
    Hay muchos 'operadores' diferentes en programación. Veamos los operadores ariméticos ahora.
...
/*
    ...
    Una función es un set de instrucciones que hace la misma 
    tarea cada vez que la llamamos.
    Las funciones toman parámetros de entrada (ARGUMENTOS o INPUT), 
    y calculan el resultado basado en esos valores y
...
//let edadUsuario = prompt('Por favor, ingrese su edad', '19');
...
//let añoNacimiento = prompt('Cual es tu año de nacimiento?');
//let añoActual = prompt('Cual es el año actual?');

//console.log('Su edad es ' + edad(añoActual, añoNacimiento));
...
/*
// crear una funcion que tome como párametro el año actual y el año de nacimiento 
// y calcule la edad del usario (mas ó menos).
// Preguntarle estos datos al usario y guardarlos en 2 variables
// Ejecutar la función con estos datos
// Impriman el resultado

// Preguntar el salario actual y calcular el salario mensual
...
/*
    ...
    Es lo mismo con el código. 
    Le podés dar una condición 'if' a una máquina para que haga una decisión acerca de qué
    ...
    Necesitamos que la condición sea un Booleano, 
    recordemos: TRUE o FALSE. Es decir, verdadero o falso.
...
/*
    ...
    Antes hicimos una introducción 
    a los operadores aritméticos de JavaScript (+, -, *, /). Ahora es momento de
...
//
// Si tenemos un operador igual a '+',
// llamamos la función 'sumar' con nuestros números (las variables del paso 2).
// Si no, tenemos que llamar la función 'restar',
// con nuestros números (las variables del paso 2).
//
